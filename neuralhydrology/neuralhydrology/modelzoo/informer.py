...
from neuralhydrology.modelzoo.Encoder import EncoderLayer, AttentionLayer, ProbAttention, Encoder, ConvLayer
...
class Informer(BaseModel):
    ...
    * ``transformer_nlayers``: number of stacked self-attention + feedforward layers.
    ...
    def forward(self, data: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # encoding
        output, attns = self.encoder(x_d, None)
